...
public class BookRentController {
    ...
    public ResponseEntity<BookRentResponseDTO> returnBook(@RequestParam Integer rentId) throws FoundException {
        BookRentResponseDTO bookRentResponseDTO = BookRentMapperConverter.generateResponseFromEntity(getBookRentService().renturnBook(rentId));
    ...
    public ResponseEntity<BookRentResponseDTO> termExtension(@PathVariable("rentId") Integer rentId) {
        BookRentResponseDTO bookRentResponseDTO = BookRentMapperConverter.generateResponseFromEntity(getBookRentService().termExtension(rentId));
